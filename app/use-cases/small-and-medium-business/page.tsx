...
const EXPLAINED = [
  {
    ...
    heading: 'One AI that reads everything your business already knows.',
    body: 'Connect your inbox, shared drives, CRM, helpdesk and team chat. AI for SMBs indexes every file, thread and record — building a single, searchable brain for your entire business. Ask anything in plain language and get a cited answer in seconds, without digging through tabs.',
    bullets: [
      'Connects Gmail, Drive, Slack, HubSpot & Notion',
      'Reads emails, docs, tickets, notes and chat threads',
      'Answers in plain language, every claim cited to the source',
    ],
    placeholder: 'Business knowledge snapshot',
  },
  {
    kicker: 'Why SMBs use it', n: '02',
    heading: 'Because small teams can\'t afford to repeat themselves.',
    body: 'At an SMB, every person wears multiple hats and institutional knowledge lives in people\'s heads, scattered inboxes and forgotten docs. AI for SMBs gives every team member instant access to the full context they need — without interrupting the one person who knows.',
    bullets: [
      'Customer history & account context on demand',
      'Policy, pricing and process answers without hunting docs',
      'Onboarding new hires in days, not weeks',
      'Consistent answers across every customer-facing team',
      'Draft proposals, follow-ups & reports from your own data',
    ],
    placeholder: 'Team knowledge hub',
  },
  {
    kicker: 'What you get', n: '03',
    heading: 'A lean team that punches above its weight, every day.',
    body: 'AI for SMBs turns your scattered business data into a reliable, cited knowledge base every team member can query. The result is faster decisions, fewer repeated questions, and a customer experience that feels like a much larger operation.',
    bullets: [
      'Instant, cited answers from your own business data',
      'Customer and account context surfaced before every call',
      'Consistent, on-brand responses across the whole team',
      'Hours saved every week per person — without extra headcount',
    ],
    placeholder: 'Cited SMB answer',
  },
]

const STEPS = [
  { kicker: 'Step 1', n: '01', title: 'Connect your tools',       body: 'Securely connect Gmail, Drive, Slack, HubSpot or whatever your team already uses. Setup takes minutes — no IT project, no migration, no new workflow to learn.' },
  { kicker: 'Step 2', n: '02', title: 'Ask anything',              body: 'Type a question like "what did we promise Acme last quarter?" or "what\'s our refund policy?" Ask naturally — you don\'t need to know where the answer lives.' },
  { kicker: 'Step 3', n: '03', title: 'Verify the cited source',   body: 'Every answer links back to the exact email, doc or record it was drawn from. One click confirms — no more "I think I saw that somewhere."' },
  { kicker: 'Step 4', n: '04', title: 'Scale across your team',    body: 'Roll out to every team member with role-based access controls. Shared knowledge, consistent answers, and a full audit trail — without extra headcount.' },
]

const PROBLEMS = [
  { icon: '⏱', title: 'Knowledge stuck in inboxes',   body: 'Surface any email, doc or conversation in seconds — no digging through folders.' },
  { icon: '◈', title: 'Repeated questions slow teams',  body: 'One question to AI for SMBs replaces five Slack pings to the one person who knows.' },
  { icon: '⚠', title: 'Inconsistent customer answers',  body: 'Every rep works from the same cited source — no more conflicting policy answers.' },
  { icon: '✉', title: 'Slow proposal & email drafts',   body: 'Draft accurate, on-brand proposals and follow-ups from your own deal and client data.' },
  { icon: '◉', title: 'Slow new-hire onboarding',       body: 'New team members self-serve company knowledge instead of blocking senior staff.' },
  { icon: '↻', title: 'Decisions without full context', body: 'Ask across every tool at once — get the full picture before every customer call.' },
]

const FEATURES = [
  { icon: '◈', title: 'Business knowledge Q&A',  body: 'Any question about your business, answered instantly from your own connected data.' },
  { icon: '⌖', title: 'Customer context',         body: 'Full account history surfaced before every call, email or meeting.' },
  { icon: '✉', title: 'Draft generation',         body: 'Proposals, follow-ups and reports drafted from real data in your connected tools.' },
  { icon: '◉', title: 'Policy & process lookup',  body: 'Instant answers to internal policy, pricing and process questions — cited to the doc.' },
  { icon: '⚔', title: 'Competitive intel',        body: 'Surface competitive context and win/loss patterns from your own calls and CRM.' },
  { icon: '🔍', title: 'Cross-tool search',       body: 'Ask one question across every connected app and get a single cited answer.' },
]

const BENEFITS = [
  'Faster customer responses',
  'Consistent team answers',
...
const STATS = [
  { n: '15 min', raw: '15',   label: 'Saved per person before every customer-facing call',  source: 'source: 12 SMB customer surveys · 2026' },
  { n: '3×',     raw: '3×',   label: 'Faster answers to internal knowledge questions',       source: 'source: ATG SMB deployment data' },
  { n: '100%',   raw: '100%', label: 'Of answers cited to the exact source document',        source: 'source: ATG answer logs' },
  { n: '4.2h',   raw: '4.2h', label: 'Saved per team member, per week',                     source: 'source: self-reported · validated' },
]

const LOGOS = ['Brightpath', 'Cornerstone', 'Nimble Co', 'Redwood Labs', 'Sprout Studio', 'Harbor Group', 'Bloom Agency', 'Keystone SMB', 'Mosaic Works', 'Pebble Tech', 'Sunrise Digital', 'Anchor Co']
const LOGOS_DOUBLED = [...LOGOS, ...LOGOS]

const MORE = [
  { icon: '◆', title: 'Sales',                    desc: 'Deal intelligence, call prep and instant CRM answers for revenue teams.',                         link: 'Explore sales use case',    href: '/use-cases/sales' },
  { icon: '✦', title: 'Marketing',                desc: 'Research campaigns, create on-brand content and get instant answers from your brand library.',     link: 'Explore marketing',         href: '/use-cases/marketing' },
  { icon: '⚖', title: 'AI for Legal Documents',  desc: 'Review contracts, extract clauses and surface risk in seconds — every answer cited to the clause.', link: 'Explore legal use case',   href: '/use-cases/ai-for-legal-documents' },
  { icon: '✚', title: 'Healthcare',               desc: 'Answer clinical, operational and compliance questions — cited from protocols, policies and rules.',  link: 'Explore healthcare',        href: '/use-cases/healthcare' },
]
      ...
      <main id="main">
        ...
        <section className="persona-hero" aria-labelledby="ph1">
          ...
          <div className="container persona-hero-inner">
            <div>
              <div className="persona-eyebrow hero-anim" style={{ animationDelay: '0ms' }}>For founders, operators &amp; growing teams</div>
              <h1 id="ph1" className="persona-h1 hero-anim" style={{ animationDelay: '90ms' }}>
                <em>AI for SMBs</em> that knows your whole business as well as you do.
              </h1>
              <p className="persona-lede hero-anim" style={{ animationDelay: '190ms' }}>
                AI for Small &amp; Medium Businesses from Ask the Genie answers any question about your customers, processes and company knowledge — grounded in your emails, docs and tools, with every answer cited. Stop losing time to scattered information and give every team member the context they need, instantly.
              </p>
            ...
            <div className="persona-visual hero-anim" style={{ animationDelay: '200ms' }} role="img" aria-label="Three illustrative SMB answer cards">
              <div className="pv-card pv-card-a float-card" style={{ animationDelay: '400ms' }}>
                <div className="pv-h">Question</div>
                <p className="pv-t">What did we promise Acme last quarter?</p>
                <span className="pv-cite">● Email · Drive · CRM</span>
              </div>
              <div className="pv-card pv-card-b float-card" style={{ animationDelay: '550ms' }}>
                <div className="pv-h">Answer · 4s</div>
                <p className="pv-t">Promised 3-month onboarding support and a custom integration by June 30. Both confirmed via email thread.</p>
              ...
              <div className="pv-card pv-card-c float-card" style={{ animationDelay: '700ms' }}>
                <div className="pv-h">Source · Gmail · Apr 12</div>
                <p className="pv-t">&ldquo;We&apos;ll have the integration live before end of June — confirmed.&rdquo;</p>
        ...
        <section className="persona-uses" id="explained" aria-labelledby="explained-h">
          <div className="container">
            <h2 id="explained-h" className="persona-uses-h" data-reveal="fade-up">AI for Small &amp; Medium Business — explained.</h2>
            <p className="persona-uses-lede" data-reveal="fade-up" style={{ '--reveal-delay': '80ms' } as React.CSSProperties}>
              AI for SMBs is software that reads everything your company already produces — emails, shared docs, CRM records, helpdesk tickets and team chats — and answers any business question in plain language, with every claim cited to the exact source. It turns hours of hunting through inboxes and folders into seconds of grounded, verifiable answers.
            </p>
            {EXPLAINED.map((item, i) => (
              ...
              >
                ...
                <div className="use-visual--img" aria-hidden="true">
                  <div className="img-slot-frame">
                    ...
                    <div className="img-slot-empty">
                      ...
                      <span className="img-slot-cap">{item.placeholder}</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="persona-more" aria-labelledby="howto-h">
          <div className="container">
            <h2 id="howto-h" className="persona-more-h" data-reveal="fade-up">How to use AI for SMBs: step-by-step.</h2>
            <p className="persona-uses-lede" data-reveal="fade-up" style={{ marginBottom: 36, '--reveal-delay': '60ms' } as React.CSSProperties}>
              Getting started takes four steps — no IT project, no implementation cost, no new workflow. Connect your existing tools, ask about any customer or process, verify the source, and roll it out across your whole team.
            </p>
        ...
        <section className="persona-more" aria-labelledby="problems-h">
          <div className="container">
            <h2 id="problems-h" className="persona-more-h" data-reveal="fade-up">Problems we solve at Ask the Genie for small and medium businesses.</h2>
        ...
        <section className="persona-more" aria-labelledby="features-h" style={{ paddingTop: 0 }}>
          <div className="container">
            <h2 id="features-h" className="persona-more-h" data-reveal="fade-up">AI for SMBs — features, benefits &amp; key capabilities.</h2>
            ...
            <div className="cs-eyebrow-row" style={{ marginTop: 48 }}>
              <span className="eyebrow">Benefits for small &amp; medium business teams</span>
            </div>
          ...
          <div className="container persona-quote-inner">
            <div className="persona-quote-card quote-hover" data-reveal="fade-right">
              <div className="persona-quote-card-inner">
                ...
                <div className="role">Co-founder &amp; CEO · Brightpath</div>
              </div>
            </div>
            <div className="persona-quote-text" data-reveal="fade-left">
              <q id="quote-h">We&apos;re a 12-person company competing against 200-person teams. Ask the Genie is the unfair advantage — every person on our team can answer any customer question in seconds, cited to the exact email or doc, without interrupting each other.</q>
              <div className="persona-quote-attr">— Brightpath · 12 seats · professional services</div>
            </div>
          </div>
        </section>
        ...
        <section className="persona-stats" aria-labelledby="stats-h" id="stats">
          <div className="container">
            <h2 id="stats-h" className="persona-stats-h" data-reveal="fade-up">The outcomes SMB teams report.</h2>
        ...
        <section className="cs-section logo-section" style={{ paddingTop: 0 }} aria-labelledby="cs-logos-h">
          <div className="container">
            <div className="cs-eyebrow-row" data-reveal="fade-up">
              <span className="eyebrow" id="cs-logos-h">Trusted by small &amp; medium businesses at</span>
            </div>
          </div>
          <div className="logo-marquee-track" role="list" aria-label="Trusted SMB teams">
